...
graphics::hist(df$height, main="", xlab=as.character(name_combo[name_combo$New == "wam",2]))
```
...
# covid_positive, living_arrangements, height, uni_travel_method, uni_travel_listen, spain_budget, feel_overseas, feel_anxious, study_hrs, read_news, study_load, work, lab_zoom, social_media, gender, sleep_time, wake_time, random_number, steak_preference, dominant_hand, normal_advanced, exercise_hrs, employment_hrs, city, weekly_saving, hourly_plan, weeks_behind, assignment_on_time, used_r_before, team_role, data2x02_hrs, 
