...
Each of these questions need to be investigated using a different test. Immediately, it is clear that

-   **`wam`** and **`employment_hrs`** are numerical variables, and

-   **`sport`** is a categorical variable.

## 1. Do DATA2902 students achieve higher WAMS than DATA2002 students?

Lets answer question 1 first. The distribution of DATA2902 WAM is fairly normal, as we can see by looking at the qqplots (@fig-qqplotwam ). It could be argued that the DATA2002 WAM distribution is not normal due to the extreme deviation of the left hand side points from the qqline.
...
Similarly, the data is somewhat symmetric, as shown in the density histogram in @fig-histwam .
...
## 2. Do DATA2902 students work a different number of hours compared to DATA2002 students?
